...
def fetch_api_results(page_number):
    print("===========================================")
    print(f"Going to fetch result for page {page_number}")
    print("===========================================")
    url = f"https://www.fotor.com/api/aigc/community/works/hot?size=10&nextId={page_number}"
...
for i in range(37):
    search_result = fetch_api_results(i + 1)
